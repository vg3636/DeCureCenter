      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-[#f8fafc] to-[#e6f7ff]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-semibold text-[#1e3a52] mb-4">Hospitality</h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-semibold text-[#2d4a63] mb-4">Patient-Centered Care Experience</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Users className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Personalized Assistance</h3>
                <p className="text-gray-700">
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Clock className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Efficient Scheduling</h3>
                <p className="text-gray-700">
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <GripHorizontal className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Coordinated Care</h3>
                <p className="text-gray-700">
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Globe className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">International Patient Support</h3>
                <p className="text-gray-700">
          ...
          <div className="bg-[#e6f7ff] rounded-lg p-8 mb-16">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6 text-center">Our Hospitality Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Patient Reception and Support</h3>
              ...
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Administrative Assistance</h3>
                  <ul className="list-disc pl-5 text-gray-700 space-y-2">
                    <li>
          ...
          <div className="mb-16">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6 text-center">Special Accommodation Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">International Patient Program</h3>
              ...
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Family Support Services</h3>
                  <p className="text-gray-700 mb-3">
              ...
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Accessibility Services</h3>
                  <p className="text-gray-700 mb-3">
          ...
          <div className="bg-[#e6f7ff] rounded-lg p-8 mb-16">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6 text-center">The De Cure Center Hospitality Difference</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Anticipating Your Needs</h3>
                <p className="text-gray-700 mb-4">
              ...
              <div className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Continuity of Care</h3>
                <p className="text-gray-700 mb-4">
              ...
              <div className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Personalized Communication</h3>
                <p className="text-gray-700 mb-4">
              ...
              <div className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Feedback-Driven Improvement</h3>
                <p className="text-gray-700 mb-4">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6">Experience Healthcare With a Personal Touch</h2>
