      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-[#f8fafc] to-[#e6f7ff]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-semibold text-[#1e3a52] mb-4">Low Vision Aids</h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-semibold text-[#2d4a63] mb-4">Maximizing Your Remaining Vision</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Search className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Magnification Devices</h3>
                <p className="text-gray-700">
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Book className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Reading Aids</h3>
                <p className="text-gray-700">
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Monitor className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Electronic Assistive Technology</h3>
                <p className="text-gray-700">
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Settings className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Daily Living Aids</h3>
                <p className="text-gray-700">
          ...
          <div className="bg-[#e6f7ff] rounded-lg p-8 mb-16">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6 text-center">Our Low Vision Assessment Process</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex justify-center mb-4">
                    <div className="w-12 h-12 rounded-full bg-[#2d4a63] text-white flex items-center justify-center text-xl font-semibold">1</div>
                  </div>
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Comprehensive Evaluation</h3>
                  <p className="text-gray-700">
              ...
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex justify-center mb-4">
                    <div className="w-12 h-12 rounded-full bg-[#2d4a63] text-white flex items-center justify-center text-xl font-semibold">2</div>
                  </div>
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Personalized Solutions</h3>
                  <p className="text-gray-700">
              ...
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex justify-center mb-4">
                    <div className="w-12 h-12 rounded-full bg-[#2d4a63] text-white flex items-center justify-center text-xl font-semibold">3</div>
                  </div>
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Training and Support</h3>
                  <p className="text-gray-700">
          ...
          <div className="mb-16">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6 text-center">Conditions We Address</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Age-Related Conditions</h3>
              ...
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Other Visual Impairments</h3>
                  <ul className="list-disc pl-5 text-gray-700 space-y-2">
                    <li>
          ...
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6">Enhance Your Visual Independence</h2>
