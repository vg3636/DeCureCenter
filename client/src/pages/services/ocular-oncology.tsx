      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-semibold text-primary-600 mb-4">Ocular Oncology</h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-semibold text-primary-600 mb-4">Expert Care for Eye Tumors and Cancers</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start mb-4">
                  <Target className="h-8 w-8 text-primary-600 mr-4 mt-1" />
                  <div>
                    <h3 className="text-xl font-semibold text-primary-600 mb-3">Diagnostic Services</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start mb-4">
                  <Microscope className="h-8 w-8 text-primary-600 mr-4 mt-1" />
                  <div>
                    <h3 className="text-xl font-semibold text-primary-600 mb-3">Treatment Modalities</h3>
                    <p className="text-neutral-700 mb-4">
          ...
          <div className="bg-primary-50 rounded-lg p-8 mb-16">
            <h2 className="text-2xl font-semibold text-primary-600 mb-6 text-center">Conditions We Treat</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-primary-600 mb-3">Intraocular Tumors</h3>
                  <ul className="list-disc pl-5 text-neutral-700 space-y-1">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-primary-600 mb-3">Conjunctival and Corneal Tumors</h3>
                  <ul className="list-disc pl-5 text-neutral-700 space-y-1">
              ...
              <Card>
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-primary-600 mb-3">Eyelid and Orbital Tumors</h3>
                  <ul className="list-disc pl-5 text-neutral-700 space-y-1">
              ...
              <div className="md:w-1/2">
                <Card>
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-xl font-semibold text-primary-600 mb-3 text-center">Patient-Centered Care</h3>
                    <p className="text-neutral-700 mb-4">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-primary-600 mb-6">Expert Care When You Need It Most</h2>
