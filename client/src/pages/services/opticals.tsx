      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-[#f8fafc] to-[#e6f7ff]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-semibold text-[#1e3a52] mb-4">Opticals</h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-semibold text-[#2d4a63] mb-4">Premium Eyewear Solutions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Glasses className="h-10 w-10 text-[#2d4a63]" />
                </div>
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Premium Frames</h3>
                <p className="text-gray-700">
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Advanced Lenses</h3>
                <p className="text-gray-700">
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex justify-center mb-4">
                  <Gauge className="h-10 w-10 text-[#2d4a63]" />
                </div>
            ...
            <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3 text-center">Efficient Service</h3>
                <p className="text-gray-700">
          ...
          <div className="bg-[#e6f7ff] rounded-lg p-8 mb-16">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6 text-center">Our Eyewear Products</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Prescription Eyeglasses</h3>
              ...
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Specialty Lenses</h3>
                  <ul className="list-disc pl-5 text-gray-700 space-y-1">
              ...
              <Card className="bg-white border border-[#d0e8f2] shadow-sm hover:shadow-md transition-all duration-300">
                <CardContent className="p-6">
                  <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Frame Collection</h3>
                  <ul className="list-disc pl-5 text-gray-700 space-y-1">
          ...
          <div className="mb-16">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6 text-center">The Optical Experience at De Cure Center</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white border border-[#d0e8f2] rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Comprehensive Eye Examinations</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-[#d0e8f2] rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Personalized Frame Selection</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-[#d0e8f2] rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Advanced Lens Consultation</h3>
                <p className="text-gray-700">
              ...
              <div className="bg-white border border-[#d0e8f2] rounded-lg p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <h3 className="text-xl font-semibold text-[#1e3a52] mb-3">Precision Fitting and Adjustments</h3>
                <p className="text-gray-700">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-[#1e3a52] mb-6">See the Difference with Quality Eyewear</h2>
