      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-semibold text-primary-600 mb-4">Prosthetic Services</h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-semibold text-primary-600 mb-4">Artistry and Precision in Ocular Prosthetics</h2>
          ...
          <div className="bg-primary-50 rounded-lg p-8 mb-16">
            <h2 className="text-2xl font-semibold text-primary-600 mb-6 text-center">Our Prosthetic Eye Services</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-start">
                    <Eye className="h-8 w-8 text-primary-600 mr-4 mt-1" />
                    <div>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="flex items-start">
                    <PenTool className="h-8 w-8 text-primary-600 mr-4 mt-1" />
                    <div>
          ...
          <div className="mb-16">
            <h2 className="text-2xl font-semibold text-primary-600 mb-6 text-center">The Prosthetic Eye Process</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-primary-600 mb-3 text-center">Initial Consultation</h3>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-primary-600 mb-3 text-center">Impression and Design</h3>
                  <p className="text-neutral-700">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-primary-600 mb-3 text-center">Fabrication and Delivery</h3>
                  <p className="text-neutral-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start">
                  <Brush className="h-8 w-8 text-primary-600 mr-4 mt-1" />
                  <div>
                    <h3 className="text-xl font-semibold text-primary-600 mb-3">Specialized Services</h3>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-start">
                  <Sparkles className="h-8 w-8 text-primary-600 mr-4 mt-1" />
                  <div>
                    <h3 className="text-xl font-semibold text-primary-600 mb-3">Ongoing Care and Support</h3>
                    <p className="text-neutral-700 mb-3">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-primary-600 mb-6">Restore Your Confidence and Appearance</h2>
