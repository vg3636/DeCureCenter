      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-semibold text-primary-600 mb-4">Vision Rehabilitation</h1>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-semibold text-primary-600 mb-4">Restore Independence and Quality of Life</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-primary-600 mb-3 text-center">Functional Vision Assessment</h3>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-primary-600 mb-3 text-center">Adaptive Training</h3>
                <p className="text-neutral-700 mb-4">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-primary-600 mb-3 text-center">Assistive Technology</h3>
                <p className="text-neutral-700 mb-4">
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-16">
            <h2 className="text-2xl font-semibold text-primary-600 mb-6 text-center">Our Comprehensive Approach</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-primary-600 mb-3">Individualized Programs</h3>
                <p className="text-neutral-700 mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-primary-600 mb-3">Multidisciplinary Care</h3>
                <p className="text-neutral-700 mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-primary-600 mb-3">Family Involvement</h3>
                <p className="text-neutral-700 mb-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-primary-600 mb-3">Ongoing Support</h3>
                <p className="text-neutral-700 mb-4">
          ...
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-primary-600 mb-6">Ready to Improve Your Visual Independence?</h2>
